...
export class HttpService {
  ...
  private initialize(): void {
    ...
    this.app.get<GetAccountBalanceRequest>("/account-balance", async (req, res) => {
    ...
    this.app.get<GetAccountAssetsRequest>("/account-assets", async (req, res) => {
      const address = verifyAddress(req, res);
      const chainId = verifyChainId(req, res);
    ...
    this.app.get<GetAccountTransactionsRequest>("/account-transactions", async (req, res) => {
      const address = verifyAddress(req, res);
      const chainId = verifyChainId(req, res);
    ...
    this.app.get<GetAccountCollectiblesRequest>("/account-collectibles", async (req, res) => {
      const address = verifyAddress(req, res);
